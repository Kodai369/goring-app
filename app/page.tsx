...
const prompts = [
  {
    label: "地",
    question: "今、足元にある確かさは何ですか？",
    sub: "今日はどんな『土台』から始めていますか？"
  },
  {
    label: "水",
    question: "心の波を揺らしているものは何ですか？",
    sub: "今、どんな感情が流れていると感じますか？"
  },
  {
    label: "火",
    question: "今日は何に情熱を感じますか？",
    sub: "内から自然に湧いてくる衝動は何ですか？"
  },
  {
    label: "風",
    question: "どんな言葉が、風のようにあなたを動かしていますか？",
    sub: "誰の声や思考が、今日のあなたに影響を与えていますか？"
  },
  {
    label: "空",
    question: "あなたが今“手放しているもの”は何ですか？",
    sub: "何を手放すことで、あなたは自由になりますか？"
  }
];
